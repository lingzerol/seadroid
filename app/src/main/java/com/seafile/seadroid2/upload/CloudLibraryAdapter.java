...
public class CloudLibraryAdapter extends ReposAdapter {
    ...
    protected int getChildLayout() {
        return R.layout.upload_repo_list_item;
    }

    @Override
    protected int getChildTitleId() {
        return R.id.upload_repo_list_item_title;
    }

    @Override
    protected int getChildSubTitleId() {
        return R.id.upload_repo_list_item_subtitle;
    }

    @Override
    protected int getChildIconId() {
        return R.id.upload_repo_list_item_icon;
    }

    @Override
    protected int getChildActionId() {
        return R.id.upload_repo_list_item_action;
    }
