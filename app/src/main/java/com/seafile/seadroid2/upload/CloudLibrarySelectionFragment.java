...
public class CloudLibrarySelectionFragment extends Fragment {
    ...
    private SeafRepo chosenRepo = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = getActivity().getLayoutInflater().inflate(R.layout.upload_multi_selection_layout, null);
        mFoldersListView = (ListView) rootView.findViewById(R.id.upload_multi_selection_lv);
        mFoldersListView.setFastScrollEnabled(true);
        mUpLayout = (RelativeLayout) rootView.findViewById(R.id.upload_multi_selection_up_layout);
        mCurrentFolderText = (TextView) rootView.findViewById(R.id.upload_multi_selection_current_directory_txt);
        mEmptyText = (TextView) rootView.findViewById(R.id.upload_multi_selection_empty_msg);
        mErrorText = (TextView) rootView.findViewById(R.id.upload_multi_selection_error_msg);
        mRefreshBtn = (ImageView) rootView.findViewById(R.id.upload_multi_selection_refresh_iv);
        mProgressContainer = rootView.findViewById(R.id.upload_multi_selection_progress_container);
        mListContainer = rootView.findViewById(R.id.upload_multi_selection_list_container);
...
//        mActivity.saveCameraUploadInfo(account, seafRepo);
    ...
    public SeafRepo getChosenRepo(){
        return chosenRepo;
    }

    public String getChosenDir(){
        return getNavContext().getDirPath();
    }
    ...
    public void loadAvatarUrls(int avatarSize) {
        ...
        if (!Utils.isNetworkOn() || !avatarManager.isNeedToLoadNewAvatars()) {
            ...
            getAccountAdapter().setAvatars((ArrayList<Avatar>) avatars);
