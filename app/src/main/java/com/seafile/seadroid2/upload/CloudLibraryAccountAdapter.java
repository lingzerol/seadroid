...
public class CloudLibraryAccountAdapter extends AccountAdapter {
    ...
    protected int getChildLayout() {
        return R.layout.upload_account_list_item;
    }

    @Override
    protected int getChildTitleId() {
        return R.id.upload_account_list_item_account_title;
    }

    @Override
    protected int getChildSubTitleId() {
        return R.id.upload_account_list_item_account_subtitle;
    }

    @Override
    protected int getChildIconId() {
        return R.id.upload_account_list_item_account_icon;
    }
}